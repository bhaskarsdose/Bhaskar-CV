...
% \begin{flushleft}\Huge\textbf{\color{BlueViolet}Bhaskar} \textbf{Dutt}\end{flushleft}
% \vspace{10pt}
% \begin{center}\LARGE\color{BlueViolet}BHASKAR\textbf{ DUTT} \end{center}\\
% \begin{flushleft}
...
\hfill\faMobile\hspace{1pt}\textit{\color{gray}+91-7042513094} \vspace{1pt}\hspace{1pt}
\faExternalLink\hspace{1pt}\href{https://sites.google.com/view/bhaskar-dutt}{\color{gray}Website}
% \end{flushright}
% \large\textit{Curriculum Vitae}\\
% \vspace{10pt} 
% \\{\begin{center} \large R\'{e}sum\'{e} \end{center} }
%\\\begin{center}\noindent\rule{17.6cm}{2pt}\end{center}\\
% \hfill\small\faGithub\hspace{1pt} \href{https://github.com/bhaskarsdose}{github.com/bhaskarsdose}\hspace{20pt}
...
% \faExternalLink\hspace{1pt}\href{https://sites.google.com/view/bhaskar-dutt}{Website} \\[8pt]
...
% \item\textbf{Embedded Firmware Developer Intern (IOT)} at \textbf{Algo8 PVT. LTD.}
% \hfill{Jan 2019 to Jun 2019}
...
\section*{\color{BlueViolet}\faBook\hspace{1pt} Education}
% It houses my academic performance
...
%projects has been added and updated
...
\section*{\color{BlueViolet}\faUniversity\hspace{1pt} Research Publications}
%Details about research publications
\begin{itemize}
...
\vspace{-1em}\item \textbf{[1] Bhaskar Dutt}, Gauri Goenka, Aakash Awasthi. \textbf{\textit{"Research paper:Automation in factories using Internet of Things(IoT)."}} At Journal of Emerging Technologies and Innovative Research (An International Open Access Journal) Paper ID A17, 2019\vspace{-1em} %published in the IETET journal PAPER ID \#A17.
\end{itemize}
...
%extra curricular activities are here :)))))
\begin{enumerate}
...
\section*{\color{BlueViolet}\faPencil\hspace{1pt} Extra-Curricular Activities} 
%extra curricular activites are here :))))
\begin{itemize}
...
% 	\item Debating.
    ...
    % \faExternalLink \url{https://bhaskarsdose.wordpress.com/}
\end{itemize}
