...
\section*{Refrence:}%refrences are here :))))
...
\section*{Declaration:}
\large I hereby confirm that all the information given above is correct and I affirm that the information given above if found faulty then I owe to face any action.
